...
#define SHMSZ     8
#define KEY_MEM 1011 //must be the same as state_machine.c
...
main()
{
    ...
    // WHILE REMOVED TO AVOID USING LOE AND SOE -- PUT IT BACK AGAIN IN FINAL VERSION <-------------
     ...
     */
    // IF REMOVED TO AVOID USING LOE AND SOE -- PUT IT BACK AGAIN IN FINAL VERSION <---------------
